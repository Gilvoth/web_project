...
<html>
   <head>
      <meta charset="UTF-8">
      <title>Все существующие документы</title>
   </head>
   <body>
...
<br> 
<div class="container">
  <form method="GET" accept-charset="UTF-8"  action="${pageContext.request.contextPath}/ViewDocsServlet">
